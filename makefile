...
CC = gcc
LD = ld
LIB = -I lib/ -I lib/kernel/ -I lib/user/ -I kernel/ -I devvice/
ASFLAGS = -f elf 
...
$(BUILD_DIR)/main.o: kernel/main.c lib/kernel/print.h \
        lib/kernel/stdint.h kernel/init.h lib/string.h kernel/memory.h \
...
$(BUILD_DIR)/init.o: kernel/init.c kernel/init.h lib/kernel/print.h \
        lib/kernel/stdint.h kernel/interrupt.h device/timer.h kernel/memory.h \
...
$(BUILD_DIR)/timer.o: device/timer.c device/timer.h lib/kernel/stdint.h\
        lib/kernel/io.h lib/kernel/print.h kernel/interrupt.h thread/thread.h kernel/debug.h kernel/global.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/memory.o: kernel/memory.c kernel/memory.h \
	lib/kernel/stdint.h lib/kernel/bitmap.h kernel/debug.h lib/string.h kernel/global.h \
	thread/sync.h thread/thread.h lib/kernel/list.h kernel/interrupt.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/thread.o: thread/thread.c thread/thread.h \
	lib/kernel/stdint.h lib/string.h kernel/global.h kernel/memory.h \
...
$(BUILD_DIR)/sync.o: thread/sync.c thread/sync.h \
	lib/kernel/stdint.h thread/thread.h kernel/debug.h kernel/interrupt.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/syscall-init.o: userprog/syscall-init.c userprog/syscall-init.h \
	lib/user/syscall.h lib/kernel/stdint.h lib/kernel/print.h kernel/interrupt.h thread/thread.h \
...
$(BUILD_DIR)/stdio.o: lib/stdio.c lib/stdio.h lib/kernel/stdint.h lib/string.h lib/user/syscall.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/stdio-kernel.o: lib/kernel/stdio-kernel.c lib/kernel/stdio-kernel.h \
    	lib/kernel/print.h lib/stdio.h lib/kernel/stdint.h device/console.h kernel/global.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/ide.o: device/ide.c device/ide.h lib/kernel/stdint.h kernel/debug.h \
...
$(BUILD_DIR)/fs.o: fs/fs.c fs/fs.h lib//kernel/stdint.h kernel/global.h device/ide.h fs/inode.h fs/dir.h \
...
$(BUILD_DIR)/dir.o: fs/dir.c fs/dir.h device/ide.h fs/fs.h fs/inode.h kernel/memory.h lib/string.h lib/kernel/stdint.h \
	lib/kernel/stdio-kernel.h kernel/debug.h fs/file.h kernel/memory.h lib/string.h kernel/debug.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/fork.o: userprog/fork.c userprog/fork.h kernel/global.h lib/kernel/stdint.h lib/string.h \
...
$(BUILD_DIR)/shell.o: shell/shell.c shell/shell.h kernel/global.h lib/kernel/stdint.h lib/string.h \
...
$(BUILD_DIR)/exec.o: userprog/exec.c userprog/exec.h thread/thread.h lib/kernel/stdint.h \
    	lib/kernel/list.h kernel/global.h lib/kernel/bitmap.h kernel/memory.h \
     	lib/kernel/stdio-kernel.h fs/fs.h lib/string.h
	$(CC) $(CFLAGS) $< -o $@
